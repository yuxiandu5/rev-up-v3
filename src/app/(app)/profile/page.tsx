...
export default function Profile() {
  ...
  if (isLoading) {
    return <Loading variant="spinner" size="lg" fullScreen text="Loading profile..." showText />;
  }
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-[var(--bg-dark1)] rounded-xl p-8 mb-8 border border-[var(--bg-dark3)]">
          <div className="flex items-center space-x-6">
            ...
            <div className="flex-1">
              <h1 className="text-3xl font-bold text-[var(--text1)] mb-2">Welcome back!</h1>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-[var(--bg-dark1)] rounded-xl p-6 border border-[var(--bg-dark3)]">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <h2 className="text-xl font-semibold text-[var(--text1)]">Account Information</h2>
            </div>
          ...
          <div className="bg-[var(--bg-dark1)] rounded-xl p-6 border border-[var(--bg-dark3)]">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <h2 className="text-xl font-semibold text-[var(--text1)]">Account Status</h2>
            </div>
        ...
        <div className="bg-[var(--bg-dark1)] rounded-xl p-6 border border-[var(--bg-dark3)]">
          <div className="flex items-center space-x-3 mb-6">
            ...
            <h2 className="text-xl font-semibold text-[var(--text1)]">Quick Actions</h2>
          </div>
