...
import { CreateMediaAssetDialog } from "./CreateMediaAssetDialog";
...
export function MediaAssetTable<TData, TValue>({
  columns,
  data,
  fetchMediaAssets,
    ...
    <div>
      ...
      <div className="flex items-center py-4 justify-between">
        <Input
          ...
          className="max-w-sm"
        />
        <CreateMediaAssetDialog onSuccess={fetchMediaAssets} />
      </div>
