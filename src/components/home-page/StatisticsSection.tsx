  ...
  return (
    ...
    >
      ...
      ">
        ...
        <div className="text-lg md:text-xl text-[var(--text1)] font-semibold">
          {label}
        </div>
      </div>
    </motion.div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-[var(--text2)] max-w-3xl mx-auto leading-relaxed">
            Our platform combines extensive automotive knowledge with precise calculations 
            to deliver the most accurate modification planning experience available.
          </p>
        </motion.div>
        ...
        >
          ...
          ">
            ...
            <p className="text-sm text-[var(--text2)]">All specifications verified against manufacturer data and real-world testing</p>
          </div>
          ...
          ">
            ...
            <p className="text-sm text-[var(--text2)]">Performance calculations update instantly as you add or remove modifications</p>
          </div>
          ...
          ">
            ...
            <p className="text-sm text-[var(--text2)]">Modification data curated by automotive professionals and enthusiasts</p>
          </div>
        </motion.div>
        ...
        >
          ...
          ">
            ...
            <p className="text-[var(--text2)] mb-6 leading-relaxed">
              Join thousands of car enthusiasts who trust our platform for their modification planning. 
              Start building your dream car today with confidence and precision.
            </p>
            <motion.a
              href="/mod"
