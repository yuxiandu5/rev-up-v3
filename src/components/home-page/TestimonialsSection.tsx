...
const testimonials = [
  {
    ...
    avatar: "MC",
    content:
      "The performance calculator is incredibly accurate! I was able to plan my entire build and the real-world results matched the predictions perfectly. Saved me thousands by choosing the right mods.",
    rating: 5,
  ...
  },
  {
    ...
    avatar: "SW",
    content:
      "This platform made modification planning so much easier. Being able to see how each mod affects the overall performance helped me prioritize my upgrades and stay within budget.",
    rating: 5,
  ...
  },
  {
    ...
    avatar: "DR",
    content:
      "The visual progress tracking and detailed specs are game-changers. I love how I can experiment with different combinations before making any purchases. Highly recommend!",
    rating: 5,
  ...
  },
  {
    ...
    avatar: "AT",
    content:
      "As someone who tracks their car regularly, having accurate performance predictions is crucial. This tool has become essential for planning my track-focused modifications.",
    rating: 5,
  ...
  },
  {
    ...
    avatar: "EC",
    content:
      "Perfect for beginners like me! The detailed descriptions and price comparisons helped me understand each modification and make informed decisions for my first build.",
    rating: 5,
    build: "Stage 1 Build",
  },
  {
    ...
    avatar: "JM",
    content:
      "The database is comprehensive and the calculations are spot-on. I've used it for multiple builds and it's never let me down. The interface is clean and intuitive too.",
    rating: 5,
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center mb-6">
        ...
        <div>
          <h3 className="text-lg font-bold text-[var(--text1)]">{testimonial.name}</h3>
          <p className="text-sm text-[var(--text2)]">{testimonial.role}</p>
        </div>
      </div>
...
export default function TestimonialsSection() {
  ...
  return (
    <section className="py-20 px-4 bg-[var(--bg-dark1)]" aria-labelledby="testimonials-title">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-[var(--text2)] max-w-3xl mx-auto leading-relaxed">
            Join thousands of satisfied car enthusiasts who have transformed their rides using our
            precision modification platform.
          </p>
        </motion.div>
        ...
        >
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div>
                <div className="text-3xl md:text-4xl font-bold text-[var(--highlight)] mb-2">
                  4.9★
                </div>
