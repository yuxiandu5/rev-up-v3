      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-[var(--text2)] max-w-3xl mx-auto leading-relaxed">
            We support the most popular performance car brands with accurate specifications 
            and comprehensive modification data for each model and year range.
          </p>
        </motion.div>
        ...
        >
          ...
          ">
            ...
            <p className="text-[var(--text2)] leading-relaxed mb-4">
              ...
              accurate baseline specifications including horsepower, torque, acceleration times, 
              and handling ratings to ensure precise modification calculations.
            </p>
