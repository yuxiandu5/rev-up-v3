...
const features = [
  {
    ...
    description: "See real-time performance changes as you add modifications. Track horsepower, torque, acceleration, and handling improvements.",
  ...
  },
  {
    ...
    description: "Browse through hundreds of performance modifications across engine, suspension, brakes, and weight reduction categories.",
  ...
  },
  {
    ...
    description: "Support for popular performance cars from BMW, Mercedes, Audi, and Porsche with accurate baseline specifications.",
  ...
  },
  {
    ...
    description: "Watch your build progress with visual indicators and see how modifications impact your car's overall performance profile.",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-[var(--text2)] max-w-3xl mx-auto leading-relaxed">
            Our comprehensive platform provides all the tools and data you need to plan, 
            calculate, and track your car modifications with precision and confidence.
          </p>
        </motion.div>
