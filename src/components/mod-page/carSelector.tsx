...
export default function CarSelector({ setPhase }: CarSelectorProps) {
  ...
  return (
    <LoadingOverlay show={loading.makes} variant="spinner" text="Loading car data..." showText>
      <section className="flex flex-col gap-4 items-center justify-center w-full min-h-full pb-10 md:gap-10">
        ...
        <Button
          disabled={selectedCar.yearRange === "" || isAnyLoading}
          onClick={() => setPhase("mod-selecting")}
        >
          Next
        </Button>
      </section>
